    ...
    $('body').imagesLoaded( function() {
      ...
      $(".item").fadeOut('slow');
       ...
       if(ww > 1200){
        ...
        if(ww>532) TweenLite.to(discover1, 1, {delay:1.5, width:"50vw", opacity:1, ease:Expo.easeInOut});
        else TweenLite.to(discover1, 1, {delay:1.5, width:"90vw", opacity:1, ease:Expo.easeInOut});
       ...
       if($(".contact").length){
           ...
           if(ww > 1200) TweenLite.to($("#email"), 1, {delay:1, width:"30vw", opacity:1, ease:Expo.easeInOut});
           else if(ww <= 1200) TweenLite.to($("#email"), 1, {delay:1, width:"90vw", opacity:1, ease:Expo.easeInOut});
           else TweenLite.to($("#email"), 1, {delay:1, width:"50%", opacity:1, ease:Expo.easeInOut});
       ...
       if($(".pagina").length){
         ...
         if(ww > 1200) TweenLite.to($(".pagina #brand2"), 1, {delay:1.3, width:"50vw", opacity:1, ease:Expo.easeInOut});
         else TweenLite.to($(".pagina #brand2"), 1, {delay:1.3, width:"100%", opacity:1, ease:Expo.easeInOut});
...
$(document).ready(function(){
   ...
   $("#brand .col-md-6").bind('inview', function(event, visible) {
	...
	if (visible) {
            if(ww > 1200) TweenLite.to($(this), 1, {width:"20vw", opacity:1, ease:Expo.easeInOut});
            else TweenLite.to($(this), 1, {width:"50vw", opacity:1, ease:Expo.easeInOut});
	...
	if (visible) {
            if(ww>532) TweenLite.to($(this).find(".line"), .3, {height:"200px", opacity:1, ease:Linear.easeOut});
            else TweenLite.to($(this).find(".line"), .3, {height:"100px", opacity:1, ease:Linear.easeOut});
   ...
   $("#show_d").bind('inview', function(event, visible) {
	if (visible) {
            if(ww > 1200) TweenLite.to($(this).find(".line"), .5, {width:"30vw", opacity:1, ease:Linear.easeOut});
            else if(ww<533) TweenLite.to($(this).find(".line"), .5, {width:"20vw", opacity:1, ease:Linear.easeOut});
            else TweenLite.to($(this).find(".line"), .5, {width:"60vw", opacity:1, ease:Linear.easeOut});
...
function ridimensiona(){
    ...
    var md6 = $(".col-md-6").width();
    var md4 = $(".col-md-4").width();
    ...
    $(".principale1 .foto1 img, .principale1 .foto2 img, .principale2 .foto1 img, .principale2 .foto2 img, .principale .foto1 img, .principale .foto2 img, .pagina .foto img").width($(".col-md-6").width());
    $(".pagina .foto img, .pagina .foto, #brand1, #brand2, .pagina .info1, .pagina .info, .pagina .brand").height(h_brand);
    if(ww > 1200) $(".pagina .brand.annie img").width(md4);
    else $(".pagina .brand.annie img").width(ww);
    if(ww > 1200) $(".pagina.sopra1 .rosa .info, .pagina.sopra1 .nero .info, .pagina.sopra1 .bianco").height(h_brand-((hh/100)*20));
    ...
    if(ww <= 1200) $(".pagina .brand.annie, .pagina .brand.annie .foto, .pagina .brand.annie img").height(h_annie_m);
...
function next(attuale, principale){
           ...
           var next = parseInt(attuale.find(".foto1 img").attr("rel"))+1;
              ...
              attuale.find(".foto2 img").attr("src", "img/collection/"+classe+next+".jpg");
              attuale.find(".foto2 img").attr("rel", next);
              principale.find(".foto2 img").attr("src", "img/collection/"+classe+succ+".jpg");
